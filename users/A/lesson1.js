...
///////////////////////////////
		...
		view1_list.setStore(new_store);

		var List_add = view1_list.store.newItem({label:" ทดสอบ เมนู ", header: true});
		var List_add = view1_list.store.newItem({label:" slide_view", value : "001", rightText: ">"});
		var List_add = view1_list.store.newItem({label:" เลือกDate", value : "002", rightText: ">"});
		var List_add = view1_list.store.newItem({label:" เลือกQuery", value : "003", rightText: ">"});
		var List_add = view1_list.store.newItem({label:" ListAddTest", value : "004", rightText: ">"});
		var List_add = view1_list.store.newItem({label:" AddName", value : "005", rightText: ">"});
		var List_add = view1_list.store.newItem({label:" AddNickname", value : "006", rightText: ">"});
		var List_add = view1_list.store.newItem({label:" Q-cid_hn", value : "007", rightText: ">"});
		var List_add = view1_list.store.newItem({label:" Devices", value : "008", rightText: ">"});
		sw2list("view1_list", "sw_1", "ทดสอบsw",1);
		//////////////////
		//// Function ////////////////////////////////////////////
		...
		on (view1_list, "click", function() {
			var newobj = selected_row("view1_list");
			var cselect = newobj.value;
			if (cselect == "001") {
			...
			if (cselect == "004") {
				...
				lautoback = true;
				clearList("txt_list");
				var List_add = txt_list.store.newItem({label:" ทดสอบตัวเลือก ", header: true});
				var List_add = txt_list.store.newItem({label:" ทดสอบ1", test_id : "001", rightText: ">"});
				var List_add = txt_list.store.newItem({label:" ทดสอบ2", test_id: "002", rightText: ">"});
				var List_add = txt_list.store.newItem({label:" ทดสอบ3", test_id:"003", rightText: ">"});
				var List_add = txt_list.store.newItem({label:" ทดสอบ4", test_id: "004", rightText: ">"});
				view1.performTransition("text_input", 1, "slide");}
			if (cselect == "005") {
				gcsource_view = "view1";
				lcvar = "c1";
				...
				clearList("txt_list");
				//list("txt_list","template.php");
				var List_add = txt_list.store.newItem({label:" ตัวเลือกชือ ", header: true});
				var List_add = txt_list.store.newItem({label:" chatree", name_id : "001", rightText: ">"});
				var List_add = txt_list.store.newItem({label:" John", name_id: "002", rightText: ">"});
				var List_add = txt_list.store.newItem({label:" chalee", name_id:"003", rightText: ">"});
				var List_add = txt_list.store.newItem({label:" uraiwan", name_id: "004", rightText: ">"});
				view1.performTransition("text_input", 1, "slide");}
			if (cselect == "006") {
				gcsource_view = "view1";
				lcvar = "c1";
				...
				clearList("txt_list");
				//list("txt_list","template.php");
				var List_add = txt_list.store.newItem({label:" ตัวเลือกชื่อเล่น ", header: true});
				var List_add = txt_list.store.newItem({label:" ปีโป้", nickname : "001", rightText: ">"});
				var List_add = txt_list.store.newItem({label:" ชายปั๊บ", nickname: "002", rightText: ">"});
				var List_add = txt_list.store.newItem({label:" เมสซี่เจ", nickname:"003", rightText: ">"});
				var List_add = txt_list.store.newItem({label:" หน้าบูด", nicname: "004", rightText: ">"});
				view1.performTransition("text_input", 1, "slide");}
			if (cselect == "007") {
				gcsource_view = "view1";
				lcvar = "c1";
